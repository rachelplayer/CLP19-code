...
int main()
{
    ...
    while (true)
    {
        cout << "\n HElib noise experiments:" << endl << endl;
...
void test_noise(int trials)
{
    ...
    for (int i = 0; i < trials; i++)
    {
        ...
        auto fresh_noise = get_noise(encrypted1, secret_key);
        ...
        auto add_noise = get_noise(encrypted1, secret_key);
        ...
        auto mult_noise = get_noise(encrypted3, secret_key);
        ...
        auto mod_switch_noise = get_noise(encrypted3, secret_key);
    ...
    cout << "Mean noise observed: " 
             << mean_fresh_observed  << endl; 
    cout << "Bit size of mean noise observed: " 
             << log(mean_fresh_observed)/log(NTL::xdouble(2))  << endl;          
    cout << "Standard deviation of noise observed: " << std_dev_fresh << endl;     
    cout << "Bit size of standard deviation of noise observed: " 
             << log(std_dev_fresh)/log(NTL::xdouble(2))  << endl;    
    cout << endl; 

    cout << "Addition c3 = (c1+c2):" << endl;
    cout << "Mean noise observed: " 
         << mean_add_observed << endl;
    cout << "Bit size of mean noise observed: " 
             << log(mean_add_observed)/log(NTL::xdouble(2))  << endl;         
    cout << "Standard deviation of noise observed: " << std_dev_add << endl; 
    cout << "Bit size of standard deviation of noise observed: " 
             << log(std_dev_add)/log(NTL::xdouble(2))  << endl;        
    cout << endl; 

    cout << "Multiplication c4 = c3 * c2 = (c1+ c2) * c2: " << endl;  
    cout << "Mean noise observed: " 
         << mean_mult_observed << endl;
    cout << "Bit size of mean noise observed: " 
             << log(mean_mult_observed)/log(NTL::xdouble(2))  << endl;         
    cout << "Standard deviation of noise observed: " << std_dev_mult << endl;  
    cout << "Bit size of standard deviation of noise observed: " 
             << log(std_dev_mult)/log(NTL::xdouble(2))  << endl;       
    cout << endl;   
    ...
    if(is_not_2048)
    {
        ...
        cout << "Mean noise observed: " 
         << mean_mod_switch_observed << endl;
        cout << "Bit size of mean noise observed: " 
             << log(mean_mod_switch_observed)/log(NTL::xdouble(2))  << endl;              
        cout << "Standard deviation of noise observed: " << std_dev_mod_switch << endl; 
        cout << "Bit size of standard deviation of noise observed: " 
             << log(std_dev_mod_switch)/log(NTL::xdouble(2))  << endl;        
        cout << endl;
    }
