    ...
    */
    ...
    public:
        ...
        */
        ...
        /*
        Computes the noise budget log((q/2) - t^2) - log(q * ||v||)
        where the noise v is the polynomial with the smallest
        infinity norm such that:
             (t/q) * ct(s) = (t/q) * Delta * m + v + at
        */
        int new_noise_budget(const Ciphertext &encrypted);
